...
#obtener del archivo data los datos del usuario
# llamar a una  funcion que haga una petición al api
# validar en la respuesta del api el tamaño del nombre de usuario que contenga 2 caracteres
    obtener_datos_usuario= data.user_body
    respuesta_api= sender_stand_request.post_new_user(obtener_datos_usuario)
    print(respuesta_api)
    body=respuesta_api.json()
    assert  body["authToken"] != ""
    assert respuesta_api.status_code == 201
